...
const DropdownTime: React.FC<DropdownTimeProps> = ({ toggleRef, isVisible, setIsVisible, showTimeZoneOption = true, customClasses }) => {
    ...
    return (
        <Dropdown toggleRef={toggleRef} isVisible={isVisible} setIsVisible={setIsVisible} customClasses={' mt-[-280px] ml-[-5px] shadow-2xl border border-color-gray-200 rounded-[4px]' + (customClasses ? ` ${customClasses}` : '')}>
            <div className="w-[260px] p-1">
                ...
                {showTimeZoneOption && (
                    <div className="p-2 mt-2">
                        ...
                        >
                            <DropdownFixedOrFloatingTimeZone toggleRef={dropdownFixedOrFloatingTimeZoneRef} isVisible={isDropdownFixedOrFloatingTimeZone} setIsVisible={setIsDropdownFixedOrFloatingTimeZone} setTimeZone={setTimeZone} />
                            <div>{timeZone}</div>
