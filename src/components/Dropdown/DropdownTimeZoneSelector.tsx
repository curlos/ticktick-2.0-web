        ...
        <Dropdown isVisible={isVisible} customClasses={' ml-[-13px] shadow-2xl border border-color-gray-200 rounded-[4px]'}>
            <div className="w-[260px]">
                <div className="flex items-center gap-1 p-1 px-2">
                    ...
                    <input placeholder="Search" value={searchText} onChange={(e) => setSearchText(e.target.value)} className="text-[13px] bg-transparent placeholder:text-[#7C7C7C] mb-0 w-full outline-none resize-none" />
                </div>
                ...
                <div ref={scrollRef} className="p-1 h-[150px] overflow-auto gray-scrollbar border-t border-color-gray-200">
