        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} position="top-center">
            <div className="rounded-xl shadow-lg bg-color-gray-650 p-5">
                ...
                <div className="p-3 bg-color-gray-600 rounded-lg">
                    ...
                    <div className="mt-2 text-color-gray-100 text-[12px]">If enabled, the status of the Focus will be synced across all devices.</div>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="bg-color-gray-600 rounded-lg">
                        <TimerOption text={"Pomo Duration"} value={pomoDuration} setValue={setPomoDuration} valueType={"Minutes"} />
                        <TimerOption text={"Short Break Duration"} value={shortBreakDuration} setValue={setShortBreakDuration} valueType={"Minutes"} />
                        <TimerOption text={"Long Break Duration"} value={longBreakDuration} setValue={setLongBreakDuration} valueType={"Minutes"} />
                        <TimerOption text={"Pomos per long break"} value={pomosPerLongBreak} setValue={setPomosPerLongBreak} valueType={"Pomos"} />
                    </div>
                </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="bg-color-gray-600 rounded-lg">
                        ...
                        <TimerOption text={"Auto-Pomo Cycle"} value={autoPomoCycle} setValue={setAutoPomoCycle} valueType={"Times"} />
                    </div>
                </div>
